...
public class MyCognitiveAgent extends CognitiveAgent {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(myKbRequest.processMessage("MedicalTermobox", "QUERY_IF", "factTrue"));
        //System.out.println(myKbRequest.processMessage("Termobox", "QUERY_IF", "factTrue"));
    }
